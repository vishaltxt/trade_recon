        ...
        <form onSubmit={handleSubmit}>
            ...
            >
                <div className='border rounded-lg text-center w-1/3 bg-yellow-100 bg-opacity-90 p-5'>
                    ...
                    <div>
                        <Link to="/register"><button className='text-blue-600 text-xl'>Register Here...</button></Link>
                    </div>
                </div>
            </div>
        </form>
...
//     return (
//         <form onSubmit={handleSubmit}>
//             {/* <img src='/login-bg.avif' alt='no image'></img> */}
...
//                     <input className='ml-5 p-1 w-1/2 rounded-lg' type='email' name='email' required value={user.email} onChange={handleInput} placeholder='enter your mail'></input>
//                 </div>
//                 <div className="p-1">
//                     <label className='text-xl text-amber-300'>Password :</label>
//                     <input className='ml-5 p-1 w-[42%] rounded-lg' type={showPassword ? 'text' : 'password'} name='password' required value={user.password} onChange={handleInput} placeholder='enter your password'></input>
//                     {/* Eye Icon */}
//                     <span
//                         onClick={togglePasswordVisibility}
//                         className="relative left-3/4 bottom-6 cursor-pointer"
...
//                 </div>
//                 <div className='p-5'>
//                     <button className='text-2xl font-bold rounded-lg border-amber-600  hover:bg-white border-2 text-amber-300  w-36'
//                         >Login</button>
//                 </div>
//             </div>
//         </form>
